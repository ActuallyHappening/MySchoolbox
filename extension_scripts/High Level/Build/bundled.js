(function () {
    ...
    ***************************************************************************** */
     ...
     * limitations under the License.
     */
    registerVersion(name, version$1, 'app');
    ...
    const signIn = () => __awaiter$1(void 0, void 0, void 0, function* () {
    ...
    */
    ...
    function na(a,b){for(let c=1;c<arguments.length;c++){const d=arguments[c];if(ba(d)){const e=a.length||0,f=d.length||0;a.length=e+f;for(let h=0;h<f;h++)a[e+h]=d[h];}else a.push(d);}}function w(a,b){this.type=a;this.g=this.target=b;this.defaultPrevented=!1;}w.prototype.h=function(){this.defaultPrevented=!0;};var oa$1=function(){if(!l.addEventListener||!Object.defineProperty)return !1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0;}});try{l.addEventListener("test",aa,b),l.removeEventListener("test",aa,b);}catch(c){}return a}();function pa$1(a){return /^[\s\xa0]*$/.test(a)}var qa=String.prototype.trim?function(a){return a.trim()}:function(a){return /^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(a)[1]};function ra(a,b){return a<b?-1:a>b?1:0}function sa$1(){var a=l.navigator;return a&&(a=a.userAgent)?a:""}function x$1(a){return -1!=sa$1().indexOf(a)}function ta$1(a){ta$1[" "](a);return a}ta$1[" "]=aa;function ua$1(a){var b=va$1;return Object.prototype.hasOwnProperty.call(b,9)?b[9]:b[9]=a(9)}var wa$1=x$1("Opera"),y=x$1("Trident")||x$1("MSIE"),xa=x$1("Edge"),ya$1=xa||y,za=x$1("Gecko")&&!(-1!=sa$1().toLowerCase().indexOf("webkit")&&!x$1("Edge"))&&!(x$1("Trident")||x$1("MSIE"))&&!x$1("Edge"),Aa=-1!=sa$1().toLowerCase().indexOf("webkit")&&!x$1("Edge");function Ba(){var a=l.document;return a?a.documentMode:void 0}var Ea;
    a:{var Fa$1="",Ga$1=function(){var a=sa$1();if(za)return /rv:([^\);]+)(\)|;)/.exec(a);if(xa)return /Edge\/([\d\.]+)/.exec(a);if(y)return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(Aa)return /WebKit\/(\S+)/.exec(a);if(wa$1)return /(?:Version)[ \/]?(\S+)/.exec(a)}();Ga$1&&(Fa$1=Ga$1?Ga$1[1]:"");if(y){var Ha=Ba();if(null!=Ha&&Ha>parseFloat(Fa$1)){Ea=String(Ha);break a}}Ea=Fa$1;}var va$1={};
    ...
    Z.g?Z.g.getResponseHeader("X-HTTP-Session-Id"):null;tb&&(d.za=tb,S$1(d.F,d.D,tb));}}c.G=3;c.l&&c.l.xa();c.$&&(c.P=Date.now()-a.F,c.j.info("Handshake RTT: "+c.P+"ms"));d=c;var h=a;d.sa=wc(d,d.H?d.ka:null,d.V);if(h.J){xc(d.h,h);var n=h,u=d.J;u&&n.setTimeout(u);n.B&&(ic$1(n),N$1(n));d.g=h;}else yc(d);0<c.i.length&&zc(c);}else "stop"!=m[0]&&"close"!=m[0]||R(c,7);else 3==c.G&&("stop"==m[0]||"close"==m[0]?"stop"==m[0]?R(c,7):Ac$1(c):"noop"!=m[0]&&c.l&&c.l.wa(m),c.A=0);}H$1(4);}catch(m){}}function Bc$1(a){if(a.W&&"function"==typeof a.W)return a.W();if("undefined"!==typeof Map&&a instanceof Map||"undefined"!==typeof Set&&a instanceof Set)return Array.from(a.values());if("string"===typeof a)return a.split("");if(ba(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}b=[];c=0;for(d in a)b[c++]=a[d];return b}
    ...
    function Kc$1(a,b){return a?b?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Lc$1(a,b,c){return "string"===typeof a?(a=encodeURI(a).replace(b,Sc$1),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Sc$1(a){a=a.charCodeAt(0);return "%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Mc=/[#\/\?@]/g,Oc=/[#\?:]/g,Nc=/[#\?]/g,Rc$1=/[#\?@]/g,Pc$1=/#/g;function Ic$1(a,b){this.h=this.g=null;this.i=a||null;this.j=!!b;}
    ...
    function oc$1(a){null!=a.B&&(l.clearTimeout(a.B),a.B=null);}function Fd(a){a.g=new L$1(a,a.j,"rpc",a.Z);null===a.o&&(a.g.H=a.s);a.g.N=0;var b=M$1(a.sa);S$1(b,"RID","rpc");S$1(b,"SID",a.I);S$1(b,"CI",a.L?"0":"1");S$1(b,"AID",a.T);S$1(b,"TYPE","xmlhttp");zd(a,b);a.o&&a.s&&vd(b,a.o,a.s);a.J&&a.g.setTimeout(a.J);var c=a.g;a=a.ka;c.K=1;c.v=dc$1(M$1(b));c.s=null;c.P=!0;ec(c,a);}k$1.cb=function(){null!=this.v&&(this.v=null,sc$1(this),tc$1(this),I(19));};function rc$1(a){null!=a.v&&(l.clearTimeout(a.v),a.v=null);}
    function mc(a,b){var c=null;if(a.g==b){rc$1(a);oc$1(a);a.g=null;var d=2;}else if(qc$1(a.h,b))c=b.D,xc(a.h,b),d=1;else return;if(0!=a.G)if(a.pa=b.Y,b.i)if(1==d){c=b.s?b.s.length:0;b=Date.now()-b.F;var e=a.C;d=Mb();C$1(d,new Pb(d,c));zc(a);}else yc(a);else if(e=b.o,3==e||0==e&&0<a.pa||!(1==d&&Bd(a,b)||2==d&&tc$1(a)))switch(c&&0<c.length&&(b=a.h,b.i=b.i.concat(c)),e){case 1:R(a,5);break;case 4:R(a,10);break;case 3:R(a,6);break;default:R(a,2);}}
